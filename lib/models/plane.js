...
var Plane = function() {
    ...
    this.name = utils.generatePlaneName();
...
Plane.prototype.checkOutOfBoundness = function() {
    return this.isOutOfBound = this.x < config.minPosition && this.x > config.maxPosition && this.y < config.minPosition && this.y > config.maxPosition
};
...
Plane.prototype.move = function() {
    if(!this.checkOutOfBoundness() && this.isAvailable()) {
